  ...
  return (
      <div className="container">
          <article className="catalog-href">
              ...
              <h1 className='title-main'>Каркасные дома</h1>
              <p>Технология каркасного строительства обеспечивает быстрое возведение доступных и экологичных коттеджей. Такие дома обладают отличной теплоизоляцией, что позволяет им быстро нагреваться и сохранять комфортную температуру в любое время года. Это делает каркасные дома идеальным выбором для тех, кто ценит комфорт и энергоэффективность.</p>
          </article>
